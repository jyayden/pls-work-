...
def insert_sample_data(database_name):
    ...
    products = [
        ...
        (9, "Hammer", 7, 5, 12.99),
        (10, "Shampoo", 8, 6, 5.50),
        (11, "Soccer Ball", 6, 4, 29.99),
        (12, "Toy Car", 9, 7, 15.00),
        (13, "Car Battery", 10, 8, 99.99),
        (14, "Sofa", 3, 9, 550.00),
        (15, "Bicycle", 6, 10, 199.99),
        (16, "Table", 3, 1, 220.00),
        (17, "Drill", 7, 5, 60.00),
        (18, "Foundation", 8, 6, 25.00),
        (19, "Jacket", 5, 3, 79.99),
        (20, "Football", 6, 4, 45.99)
    ]
    ...
    orders = [
        ...
        (5, 5, "2024-03-01", "Processing"),
        (6, 6, "2024-03-15", "Shipped"),
        (7, 7, "2024-04-01", "Delivered"),
        (8, 8, "2024-04-10", "Shipped"),
        (9, 9, "2024-04-20", "Processing"),
        (10, 10, "2024-05-01", "Cancelled")
    ]
    ...
    reviews = [
        ...
        (5, 5, 5, 2, "Not worth the price."),
        (6, 6, 6, 4, "Nice pen set for the price."),
        (7, 7, 7, 5, "Love the T-shirt!"),
        (8, 8, 8, 3, "Good, but there are better options."),
        (9, 9, 9, 4, "Solid hammer, does the job."),
        (10, 10, 10, 5, "Fantastic soccer ball!")
    ]
